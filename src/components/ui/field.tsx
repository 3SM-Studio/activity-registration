...
const fieldVariants = cva(
  "group/field flex min-w-0 w-full gap-3 data-[invalid=true]:text-destructive",
  {
    variants: {
      orientation: {
        vertical: ["flex-col [&>*]:min-w-0 [&>*]:w-full [&>.sr-only]:w-auto"],
        horizontal: [
        ...
        responsive: [
          "flex-col @md/field-group:flex-row @md/field-group:items-center [&>*]:min-w-0 [&>*]:w-full @md/field-group:[&>*]:w-auto [&>.sr-only]:w-auto",
